      ...
      <div class="site-nav">
        <div class="nav-inner">
          ...
          <div class="nav-links">
            ...
            <a class="nav-button" href="setup-variables.html">Setup Guide</a>
            <a class="nav-button" href="additional-integrations.html">Integrations</a>
    ...
    return `
      <footer class="footer page-shell">
        <div class="footer-inner">
          <div>&copy; ${new Date().getFullYear()} ${site.brand.name}</div>
          <div>
